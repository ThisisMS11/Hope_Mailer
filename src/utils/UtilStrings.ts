export const defaultEmailSubjectForFollowUp = `Following Up on My {{jobPosition}} Application at {{company}}`;

export const defaultEmailTemplateForFollowUp = `
Dear {{person}}, 
...
I have also gained practical experience as a software developer Intern at <a href="https://pixaflip.com/" target="_blank" style="color: #007bff; text-decoration: none;">Pixaflip Technologies</a><br> and <a href="https://www.catoff.xyz/" target="_blank" style="color: #007bff; text-decoration: none;">CatOff</a><br>.
...
export const defaultEmailSubjectForReferral = `Seeking Your Guidance for a {{jobPosition}} role at {{company}}`;

export const defaultEmailTemplateForReferral = `Dear {{person}},
