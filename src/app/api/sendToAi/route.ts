...
export const POST = async (req: NextRequest) => {
    try {
        ...
        try {
            ...
            return makeResponse(200, true, 'Email content successfully generated.', responseText);
        } catch (error) {
            logger.error(`Error while communicating with Gemini API: ${error}`);
            return makeResponse(500, false, 'AI service error. Please try again later.', null);
        }
    } catch (error) {
